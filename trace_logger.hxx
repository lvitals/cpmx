...
// In one source file, declare the TraceLogger named tracer like this:
//    TraceLogger tracer;
...
public:
    TraceLogger() : fp(NULL), quiet(false), flush(true) {}
    ...
    void TraceDebug(bool condition, const char *format, ...)
    {
        ...
        (void)condition; // Avoid unused variable warning
